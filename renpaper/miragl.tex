...
\fvset{fontsize=\small, fontfamily=helvetica, fontseries=b, xleftmargin=2em}
...
\section{Key Design Decisions (This title is copied straight from the Cg
paper.  Is that bad?)[No, I don't think so]}
...
Notice that no types are explicitly specified.  However, when {\verb result} is evaluated, <var>foo 
...
<<moved.  For simplicity of implementation and to leverage the extensive design work that 
