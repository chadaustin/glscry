...
naïve implementation.  [ref The Implementation of Functional Programming Languages, Simon Peyton-Jones]
...
and |vec4 1.0 1.0 1.0 1.0| are equally valid and have the same result.  There 
