...
struct CPUInfo {
    ...
    struct Features {
        ...
        bool cmov;   ///< Conditional Move/Compare Instruction
        ...
        bool ds;     ///< Debug Store
        bool acpi;   ///< Thermal Monitor and Clock Ctrl
        ...
        /// Only valid if serial is true.
        char serialNumber[29 + 1];

        int logicalProcessorsPerPhysical;
        int CLFLUSHCacheLineSize;  // In 8-byte increments.
        int APIC_ID;
